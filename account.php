...
<nav class="navbar navbar-default title1">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#"><b>QUI TECH</b></a>
    </div>
...
if (@$_GET['q'] == 'result' && @$_GET['eid']) {
  ...
  <center><h1 class="title" style="color:#660033">Resultados</h1></center><br />
...
if (@$_GET['q'] == 2) {
  ...
  // Recorrer los resultados del historial
  while ($row = mysqli_fetch_array($q)) {
      $eid = $row['eid'];
      $s = $row['score'];
      $w = $row['wrong'];
      ...
      // Calcular el promedio (considerando que `sahi` es el puntaje por respuesta correcta)
      $promedio = 0;
      if ($qa > 0) {
          $promedio = ($r / $qa) * 100;  // Calcular el promedio como porcentaje
      }

      // Asegurarse de que el promedio no sea negativo
      if ($promedio < 0) {
          $promedio = 0;
      }
      ...
      echo '<tr>
              ...
              <td><a href="' . $youtube_link . '" target="_blank">' . $youtube_link . '</a></td>
            </tr>';
  }
...
if (@$_GET['q'] == 3) {
  ...
  while ($row = mysqli_fetch_array($q)) {
      ...
      // Obtener el historial del usuario para calcular el promedio
      $q12 = mysqli_query($con, "SELECT * FROM history WHERE email='$e'") or die('Error231');
      while ($historyRow = mysqli_fetch_array($q12)) {
          $totalScore += $historyRow['score'];
          $totalExams++;
      }
      ...
      while ($userRow = mysqli_fetch_array($q12)) {
          $name = $userRow['name'];
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/avatar.jpg" width=100 height=100 alt="QUI TECH" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		...
		<h4 style="font-family:'typo' ">QUI TECH</h4></div></div>
		</p>
      </div>
